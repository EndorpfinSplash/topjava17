...
public class JdbcMealRepository implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()) {
            ...
            meal.setId(newKey.intValue());
                ...
                "UPDATE meals SET date_time=:datetime, description=:desrioption, calories=:calories " +
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        ...
        return jdbcTemplate.query("SELECT * FROM meals where user_id = ? " +
                "and date_time between ? and ? ORDER BY date_time, description", ROW_MAPPER, userId, startDate, endDate);
    }
}
